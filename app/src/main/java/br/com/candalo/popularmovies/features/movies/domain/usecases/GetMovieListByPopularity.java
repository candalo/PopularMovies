...
public class GetMovieListByPopularity extends BaseUseCase<List<Movie>, Void> {

    private MovieRepository movieRepository;
    private MovieQuerySpec movieQuerySpec;

    @Inject
    public GetMovieListByPopularity(MovieRepository movieRepository, MovieQuerySpec movieQuerySpec) {
